...
import pdf from "../../Fichas tecnicas/FICHA TECNICA CARBOXIMETILCELULOSA CMC GRADO ALIMENTICIO (CHINA) KG 25 LOTE 202209100.pdf";
    ...
    style={{
      ...
      transition: "all 0.9s cubic-bezier(0.17, 0.55, 0.55, 1) 0.5s"
        ...
        <button className="text-black px-6 py-2 bg-[#00c08d] rounded-xl hover:bg-[#F6FA70] hover:text-black font-semibold duration-300 ease-in-out mx-2 flex">
            <a download={pdf} href={pdf}>{t("download.data")}</a>
        </button>
    </div>
  )
}
