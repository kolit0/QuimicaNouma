            ...
            <div className="bg-cover bg-blend-multiply bg-gray-500 md:h-96 h-52 w-full place-items-center flex" style={{backgroundImage: `url(${fondoQuimica})`}}>
                <div className=" w-full space-y-2">
                    <div className="bg-gray-300 bg-opacity-40 backdrop-blur-md text-white w-auto h-auto place-items-center flex">
                        <h1 className="md:text-7xl text-3xl md:pl-60 pl-10 font-semibold">{t("clean.title")}</h1>
                    </div>
                    <div className="place-items-center flex space-x-3">
                        ...
                        <div>
                            <a href="../Home" className="md:text-xl text-white font-extralight underline hover:text-blue-500">{t("clean.subTitle")}</a>
                        </div>
                        ...
                        <div>
                            <a href="../Products" className="md:text-xl text-white font-extralight underline hover:text-blue-500">{t("clean.subTitle2")}</a>
                        </div>
                        <div className="flex place-items-center">
                            <FaChevronRight className="text-white"/>
                        ...
                        <div>
                            <h2 className="md:text-xl text-white font-extralight">{t("clean.title")}</h2>
                        </div>
                    </div>
                </div>
            </div>
